...
- [Что такое focus trap и когда он нужен?](https://youtu.be/9o_PsbrnOyI?t=412)
- [Разница между `aria-hidden` и `display: none` с точки зрения доступности?](https://youtu.be/9o_PsbrnOyI?t=466)
