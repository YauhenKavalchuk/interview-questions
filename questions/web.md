...
- [Разница между SOAP и REST API?](https://youtu.be/Tx5ABBxYs-Y?t=280)
...
- [Что такое `HTTP/3`? Особенности `HTTP/3`?](https://youtu.be/Tx5ABBxYs-Y?t=415)
...
- [Разница между `GET` и `POST` запросами?](https://youtu.be/V39eEU9Pwv0?t=742)
